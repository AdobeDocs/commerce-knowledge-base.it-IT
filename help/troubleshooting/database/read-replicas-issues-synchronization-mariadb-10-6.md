---
title: Leggi i problemi relativi alle repliche su Adobe Commerce Cloud 2.4.6 con MariaDB 10.6
...
# Leggi i problemi relativi alle repliche su Adobe Commerce Cloud 2.4.6 con MariaDB 10.6

Questo articolo fornisce soluzioni per comportamenti imprevisti quando si utilizzano repliche di lettura su Adobe Commerce Cloud 2.4.6 con MariaDB 10.6+.
...
1. Verificare che il parametro `slave_parallel_mode` sia impostato su *conservativo* (sarà necessario [alzare un ticket di supporto](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide.html?lang=it#submit-ticket) se il valore non è visualizzato come *conservativo*). Per eseguire il controllo, eseguire il comando seguente:
...
* [Configurare le variabili di ambiente per la distribuzione](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/configure/env/configure-env-yaml.html?lang=it) nella Guida all&#39;infrastruttura di Commerce su Cloud.
* [Best practice per la configurazione del database](https://experienceleague.adobe.com/docs/commerce-operations/implementation-playbook/best-practices/planning/database-on-cloud.html?lang=it) nella playbook di implementazione.
