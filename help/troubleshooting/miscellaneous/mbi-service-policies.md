...
* [Creazione e modifica delle informazioni sull&#39;account utente](https://experienceleague.adobe.com/docs/commerce-business-intelligence/mbi/administrator/user-mgmt/user-management.html?lang=it)
* Inserimento o modifica delle informazioni di fatturazione
* [Condivisione di dashboard con altri utenti](https://experienceleague.adobe.com/docs/commerce-business-intelligence/mbi/build/dashboards/share-dashboard-with-users.html?lang=it)
* Discussione, creazione o modifica di connessioni dati e dettagli del server
* Esecuzione di funzioni a livello di amministratore per utenti standard o di sola lettura (ad esempio [aggiunta/modifica di metriche](https://experienceleague.adobe.com/docs/commerce-business-intelligence/mbi/build/reports/ess-manage-data-metrics.html?lang=it))
...
* **Insegnamento SQL** - Utilizzare SQL Report Builder, ma non si conosce SQL? Nessun problema. Abbiamo creato un [tutorial](https://experienceleague.adobe.com/docs/commerce-business-intelligence/mbi/analyze/sql/sql-rpt-bldr.html?lang=it) per aiutarti con le nozioni di base.

* **Problemi di visualizzazione SQL non causati da difetti del prodotto** - Se un grafico si chiude con un aspetto un po&#39; imprevisto e **non è** causato da un difetto del prodotto, è probabile che la causa sia la query stessa. Dai un&#39;occhiata al nostro [tutorial Creazione di visualizzazioni da query SQL](https://experienceleague.adobe.com/docs/commerce-business-intelligence/mbi/tutorials/create-visuals-from-sql.html?lang=it) nella nostra guida utente per informazioni su come strutturare le query per la visualizzazione.
* **Debug delle query SQL** - Di tanto in tanto, potrebbero verificarsi errori non EXPLAIN che impediscono l&#39;esecuzione della query. È consigliabile fare riferimento alla [Guida utente di Commerce Intelligence: utilizzo di SQL Report Builder](https://experienceleague.adobe.com/docs/commerce-business-intelligence/mbi/analyze/sql/sql-rpt-bldr.html?lang=it) e del tutorial SQL per individuare la causa del problema.

## Come si invia un ticket?

Puoi [inviare un ticket](https://experienceleague.adobe.com/it/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide) al nostro team di supporto facendo clic sul collegamento **Invia un ticket** nella parte superiore della pagina. È consigliabile estrarre [le informazioni nel ticket di supporto](https://experienceleague.adobe.com/it/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide) prima di contattarci per verificare che tutte le informazioni necessarie siano presenti nell&#39;invio iniziale.
