...
description: In questo articolo vengono fornite soluzioni per la risoluzione delle discrepanze tra un report di Magento Business Intelligence (MBI) e una query o un report di terze parti.
...
In questo articolo vengono fornite soluzioni per la risoluzione delle discrepanze tra un report di Magento Business Intelligence (MBI) e una query o un report di terze parti.
...
1. Rivedi e conferma altre manipolazioni di dati all’interno del rapporto:
   ...
   * [Opzioni di tempo](https://experienceleague.adobe.com/docs/commerce-business-intelligence/mbi/tutorials/using-visual-report-builder.html?lang=it)
...
**Ancora bloccato?** Non preoccuparti, siamo qui per aiutarti. Invia una richiesta utilizzando [queste istruzioni](/help/troubleshooting/miscellaneous/mbi-data-discrepancies.md).
