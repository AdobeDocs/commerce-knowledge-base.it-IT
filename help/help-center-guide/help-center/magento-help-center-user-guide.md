...
![accedi a experience-league](assets/experience_league_sign_in.png)
...
>1. Se il menu a discesa **[!UICONTROL Select a product]** è vuoto durante l&#39;invio di un caso, è probabile che si stia utilizzando un account Adobe Commerce Partner. Solo gli utenti con [Accesso condiviso](#shared-access) da un commerciante con diritti di supporto possono inviare i biglietti. Per i problemi relativi agli esercenti, richiedere l&#39;accesso condiviso. Per i problemi relativi ai partner, contattare spphelp@adobe.com.
...
>1. Se si è sottomesso il caso per OrgA-Product1 e si desidera esaminare [!UICONTROL My Cases] per tale organizzazione in futuro, non sarà possibile visualizzarlo selezionando OrgA-Product2 come organizzazione (sarà sufficiente selezionare l&#39;altra organizzazione, rispetto all&#39;esempio B).
>
...
>
>Se non riesci a selezionare un prodotto diverso (ad esempio, il menu a discesa **Seleziona un prodotto** è vuoto o non visualizzato), in genere ciò è dovuto a uno dei seguenti motivi:
>
...
1. Fare clic sulla scheda **Supporto**.
   ...
   ![scheda_supporto_account_magento](assets/magento_account_support_tab.png){width="800"}
...
![Errore_Indirizzo_E_-Mail](assets/Verify_Email_Address_Error.png)
...
Puoi visualizzare i casi Commerce che hai inviato personalmente facendo clic su **[!UICONTROL My Cases]** nel menu a sinistra. Assicurati di aver selezionato l’organizzazione corretta che termina con &quot;(Commerce)&quot;.
...
Puoi visualizzare i casi Commerce a cui sei stato *aggiunto come utente watcher* facendo clic su **[!UICONTROL My organization's cases]** nel menu a sinistra.
...
1. Dopo aver fatto clic su, viene visualizzato un modulo popup. Compila il modulo e fai clic su **[!UICONTROL Escalate]**.
   ...
   ![conferma-escalation](assets/confirm_escalation.png)
...
1. Dopo aver fatto clic sulla matita, puoi aggiungere o rimuovere gli osservatori dall’elenco.
   ...
   ![aggiorna-watcher](assets/update_watchers.png)
...
>[!NOTE]
>
>Non puoi riaprire un caso rispondendo a una notifica e-mail da un ticket chiuso. Per riaprire il caso, accertarsi che il proprietario dell&#39;account ti abbia fornito [Accesso condiviso](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26164).
...
1. Trovare l&#39;utente da cui revocare l&#39;accesso condiviso e fare clic sull&#39;icona ![rimuovi](assets/remove_icon.png){width="25"} nella riga dell&#39;utente (**Azioni** colonna).
