...
[Aggiornamento di sicurezza disponibile per Adobe Commerce | APSB26-146](https://helpx.adobe.com/it/security/products/magento/apsb26-146.html)
...
>[!NOTE]
>
>L’hotfix per CVE-2026-75650 è ora compatibile con tutte le versioni di Adobe Commerce e Magento Open Source tra la 2.4.4 e la 2.4.7. Fare riferimento alla tabella seguente e scaricare la patch applicabile alla propria versione.

Per risolvere la vulnerabilità dei prodotti e delle versioni interessati, è necessario applicare la **patch sottostante** (a seconda della versione) e ruotare le chiavi di crittografia.

| Numero versione | Patch |
|---|---|
| 2,4.9-2026-ago, 2,4.8-2026-ago, 2,4.7-2026-ago, 2,4.6-2026-ago, 2,4.5-2026-ago, 2,4.4-2026-ago, 2,4.9-2026-lug, 2,4.8-2026-lug, 2,4.7-2026-lug, 2,4.6-2026-lug, 2,4.5-2026-lug, 2,4.4-2026-lug, 2,4,8-p5, 2,4,8-p4, 2,4,7-p10, 2,4,7-p9, 2,4,6-p15, 2,4,6-p14, 2.4.5-p17, 2.4.5-p16, 2.4.4-p18, 2.4.4-p17 | [Hotfix VULN-39341-compositore-patches.zip](https://repo.magento.com/patch/VULN-39341-composer-patches.zip) |
...
1. Ruota database e credenziali Fastly (tramite ticket di supporto).
...
* [Bollettino sulla sicurezza di Adobe (APSB26-146)](https://helpx.adobe.com/it/security/products/magento/apsb26-146.html)
* [Ultimi aggiornamenti di sicurezza disponibili per Adobe Commerce](https://helpx.adobe.com/it/security/products/magento.html)
