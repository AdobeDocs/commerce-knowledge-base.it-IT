...
* Strumenti di supporto {#support-tools}
   ...
   * Patch disponibili nello strumento QPT {#patches}
      ...
      * v1.1.22 {#v1-1-22}
         ...
         * [ACSD-47444 [!UICONTROL Trying to access array offset on value of type bool] errore durante l’accesso a determinati percorsi di categoria non esistenti per prodotti noti in PHP 7.4](/help/support-tools/patches-available-in-qpt-tool/v1-1-22/acsd-47444-trying-access-array-offset-value-type-bool-error.md)
      ...
      * v1.1.23 {#v1-1-23}
         ...
         * [ACSD-46519: product_count in [!UICONTROL categoryList] [!DNL GraphQL] la query restituisce 0 per le categorie di ancoraggio](/help/support-tools/patches-available-in-qpt-tool/v1-1-23/acsd-46519-product-count-categorylist-graphql-query-returns-zero-anchor-categories.md)
      ...
      * v1.1.24 {#v1-1-24}
         ...
         * [ACSD-47336 [!UICONTROL Something went wrong] notifiche di errore ignorate dall’amministratore di Adobe Commerce](/help/support-tools/patches-available-in-qpt-tool/v1-1-24/acsd-47336-something-went-wrong-error-when-dismissing-notifications-adobe-commerce-admin.md)
      ...
      * v1.1.25 {#v1-1-25}
         ...
         * [ACSD-48313 [!UICONTROL configurable_variations] colonna non analizzata se il valore dell’attributo contiene una virgola](/help/support-tools/patches-available-in-qpt-tool/v1-1-25/acsd-48313-configurable-variations-column-not-parsed-attribute-value-contains-comma.md)
      ...
      * v1.1.29 {#v1-1-29}
         ...
         * [ACSD-49835 [!UICONTROL Use Default Value] casella di controllo non salvata](/help/support-tools/patches-available-in-qpt-tool/v1-1-29/acsd-49835-use-default-value-chekbox-not-saved.md)
         ...
         * [ACSD-49502: collegamento scaricabile non aggiornato correttamente dopo [!DNL staging] aggiorna](/help/support-tools/patches-available-in-qpt-tool/v1-1-29/acsd-49502-downloadable-link-not-updated-correctly.md)
      ...
      * v1.1.32 {#v1-1-32}
         ...
         * [ACSD-49628 [!DNL Page Builder] Errori CORS impediscono il salvataggio del prodotto](/help/support-tools/patches-available-in-qpt-tool/v1-1-32/acsd-49628-page-builder-cors-errors-prevent-product-save.md)
         ...
         * [ACSD-51379: modifiche al contenuto di testo della pagina tramite [!DNL Page Builder] non sono salvati](/help/support-tools/patches-available-in-qpt-tool/v1-1-32/acsd-51379-changes-made-to-page-text-content-via-page-builder-are-not-saved.md)
      ...
      * v1.1.33 {#v1-1-33}
         ...
         * [ACSD-51735: lo stato dell&#39;articolo dell&#39;ordine non è impostato correttamente su [!UICONTROL Ordered] quando le scorte di prodotto sono pari a 0](/help/support-tools/patches-available-in-qpt-tool/v1-1-33/acsd-51735-order-item-status-incorrectly-set.md)
      ...
      * v1.1.35{#v1-1-35}
         ...
         * [ACSD-51149: pianificato [!UICONTROL ImportExport] con abilitato [!UICONTROL Catalog Permissions] invalida gli indici](/help/support-tools/patches-available-in-qpt-tool/v1-1-35/acsd-51149-scheduled-importexport-enabled-catalog-permissions-invalidates-indexers.md)
         ...
         * [ACSD-52786: regola catalogo [!UICONTROL SKU is] si applica a tutti i prodotti che iniziano con SKU](/help/support-tools/patches-available-in-qpt-tool/v1-1-35/acsd-52786-catalog-rule-sku-is-applies-to-all-products-starting-with-it.md)
      ...
      * v1.1.36{#v1-1-36}
         ...
         * [ACSD-53239: l’indicizzatore del magazzino pulisce tutte le cache nel [!UICONTROL Update on Schedule] modalità](/help/support-tools/patches-available-in-qpt-tool/v1-1-36/acsd-53239-inventory-indexer-cleans-all-caches.md)
         * [ACSD-50887 [!UICONTROL Use in Search Results Layered Navigation] impostato su Sì senza [!UICONTROL Use in Search] opzione](/help/support-tools/patches-available-in-qpt-tool/v1-1-36/acsd-50887-product-attribute-use-in-search-results-layered-navigation-set-to-yes-without-use-in-search-option.md)
         * [ACSD-51846: errore interno come [!DNL REST API] i livelli di payload non sono convalidati](/help/support-tools/patches-available-in-qpt-tool/v1-1-36/acsd-51846-internal-error-as-levels-of-rest-api-payload-are-not-validated.md)
      ...
      * v1.1.40 {#v1-1-40}
         ...
         * [ASCD-54040: [!UICONTROL Created] è vuoto nei dettagli dell’ordine quando i moduli B2B sono abilitati](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-54040-created-field-is-blank-in-order-details-page.md)
         ...
         * [ACSD-54319: il prezzo del prodotto è pari a zero nella [!UICONTROL Products in Carts] rapporto](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-54319-product-price-shows-zero-in-product-in-cart-report.md)
         * [ACSD-54989: l’amministratore della società non può ordinare quando [!UICONTROL Enable Purchase Orders] impostato su Sì e [!UICONTROL Purchase Order] imposta su No](/help/support-tools/patches-available-in-qpt-tool/v1-1-40/acsd-54989-order-placement-restrictions-in-company-admin-settings.md)
      ...
      * v1.1.42 {#v1-1-42}
         ...
         * [ACSD-53568 [!UICONTROL Recently Viewed Product] i dati non vengono aggiornati correttamente nella visualizzazione archivio](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-53658-fixes-the-issue-where-recently-viewed-product-data-is-not-updated-in-the-store-view.md)
         ...
         * [ACSD-55112 [!UICONTROL Submit Review] è possibile fare clic più volte sul pulsante](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-55112-submit-review-button-can-be-clicked-multiple-times.md)
         ...
         * [ACSD-54890: cause aggregate_sales_report_bestsellers_data [!DNL MySQL] errori](/help/support-tools/patches-available-in-qpt-tool/v1-1-42/acsd-54890-aggregate-sales-report-bestsellers-data-causes-mysql-errors.md)
      ...
      * v1.1.43 {#v1-1-43}
         ...
         * [ACSD-55305: blocco dei popup durante la modifica dell’utente aziendale in [!UICONTROL My Account]](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-55305-freeze-issue-in-company-user-edit-popup.md)
         ...
         * [ACSD-53636: il prezzo normale non viene visualizzato su [!UICONTROL Product Listing] pagina](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-53636-regular-price-is-not-displayed-on-product-listing-page.md)
         ...
         * [ACSD-53309: applicazione fiscale incompleta per le opzioni personalizzabili e &#39;[!UICONTROL Regular Price]etichetta &#39;](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-53309-incomplete-tax-application-for-customizable-options.md)
         ...
         * [ACSD-54739 [!UICONTROL Product Stock] stato non applicato per [!UICONTROL Related Product Rules]](/help/support-tools/patches-available-in-qpt-tool/v1-1-43/acsd-54739-product-stock-status-not-applied-for-related-product-rules.md)
      ...
      * v1.1.44 {#v1-1-44}
         ...
         * [ACSD-55352: creazione [!UICONTROL Credit Memo] con punti premio](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-55352-creating-credit-memos-with-reward-points.md)
         ...
         * [ACSD-56193 [!DNL Fastly/Varnish] cache non cancellata per l&#39;aggiornamento della gestione temporanea del contenuto](/help/support-tools/patches-available-in-qpt-tool/v1-1-44/acsd-56193-fastly-cache-not-cleared-for-content-staging-update.md)
      ...
      * v1.1.45 {#v1-1-45}
         ...
         * [ACSD-54965 [!UICONTROL Visual Merchandising] la griglia non visualizza il materiale corretto](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-54965-visual-merchandising-grid-not-display-correct-stock.md)
         ...
         * [ASCD-56415: Prestazioni di [!UICONTROL Partial Price Indexing] è rallentato a causa di query DELETE](/help/support-tools/patches-available-in-qpt-tool/v1-1-45/acsd-56415-performance-of-partial-price-indexing-is-slowed-down-due-to-a-delete-query.md)
      * v1.1.46 {#v1-1-46}
         * [Panoramica: [!DNL Quality Patches Tool] (QPT) v1.1.46](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/overview.md)
         * [ACSD-46767 [!UICONTROL Category] le cache delle pagine annullano la validità quando cambia la quantità delle scorte](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/acsd-46767-category-page-caches-invalidate-when-the-stock-quantity-changes.md)
         * [ACSD-54656: invisibile [!DNL reCAPTCHA] non riesce durante il pagamento, impedendo il posizionamento dell&#39;ordine](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/acsd-54656-invisible-recaptcha-fails-during-checkout-preventing-order-placement.md)
         ...
         * [ACSD-55100 [!DNL GraphQL] non restituisce prodotti oltre i 10.000 nei risultati di ricerca](/help/support-tools/patches-available-in-qpt-tool/v1-1-46/acsd-55100-graphql-does-not-return-products-beyond-10k-in-the-search-results.md)
      ...
      * v1.1.48 {#v1-1-48}
         ...
         * [ACSD-57315: creazione nuova transazione in [!DNL PayPal Payflow Pro] ogni volta che si fa clic sul pulsante fetch](/help/support-tools/patches-available-in-qpt-tool/v1-1-48/acsd-57315-new-transaction-created-in-paypal-payflow-pro-each-time-the-fetch-button-is-clicked.md)
...
* Risoluzione dei problemi {#troubleshooting}
   ...
   * Database {#database}
      ...
      * [valore numerico del database Adobe Commerce non compreso nell’intervallo valido, [!DNL INT] a [!DNL BIGINT]](/help/troubleshooting/database/int-biginit-schema-update-request.md)
   ...
   * Pagamenti {#payments}
      * [Risolvere i problemi relativi alla pagina Crea ordine in [!UICONTROL CSP] modalità con restrizioni](/help/troubleshooting/payments/admin-create-order-page-in-csp-restricted-mode.md)
      * [Risolvere i problemi relativi alla pagina di estrazione storefont in [!UICONTROL CSP] modalità con restrizioni](/help/troubleshooting/payments/storefront-checkout-page-in-csp-restricted-mode.md)
   ...
   * Installazione e aggiornamento {#installation-and-upgrade}
      ...
      * [[!DNL B2B] Installazione di 1.4.0 non riuscita in Adobe Commerce 2.4.6-p1 on-premise](/help/troubleshooting/installation-and-upgrade/b2b-1-4-0-installation-fails-on-adobe-commerce-2-4-6-p1-on-premises.md)
   ...
   * Varie {#miscellaneous}
      ...
      * [Impostazione dell’errore di annullamento della serializzazione Redis:static-content:distribuire](/help/troubleshooting/miscellaneous/redis-unserialize-error-setup-static-content-deploy.md)
      ...
      * [Impossibile eliminare il file. Attenzione! scollega: errore di file o directory non presente* dal [!DNL Admin]](/help/troubleshooting/miscellaneous/file-cannot-be-deleated-no-file-or-directory.md)
      * [[!DNL Admin] accesso non funzionante - dimensione massima sessione consentita superata](/help/troubleshooting/miscellaneous/admin-login-not-working-allowed-session-max-size-exceed.md)
      ...
      * [Le vulnerabilità rilevate dalle scansioni di sicurezza di terze parti devono essere indirizzate a [!DNL HackerOne]](/help/troubleshooting/miscellaneous/third-party-test-reports-are-handled-by-hackerone.md)
      ...
      * [[!DNL SendGrid] limitazione dei file per Adobe Commerce Cloud](/help/troubleshooting/miscellaneous/sendgrid-file-limitation.md)
