...
description: '[Gli utenti amministratori](https://experienceleague.adobe.com/en/docs/commerce-business-intelligence/mbi/administrator/user-mgmt/user-management) possono creare e modificare determinate colonne calcolate in Data Warehouse Manager. Queste colonne calcolate consentono di impostare il reporting che si desidera ottenere per rispondere a domande aziendali chiave.'
...
Per l’elenco delle colonne calcolate che è possibile creare in Data Warehouse Manager e per istruzioni su come configurarle correttamente, consulta i seguenti articoli nella guida utente:
...
Se hai bisogno di assistenza per creare una colonna calcolata normale o vuoi creare o modificare una colonna calcolata avanzata, [rivolgiti al nostro team](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket) e includi quanto segue:
...
* [MBI: informazioni della Guida su Magento BI](https://experienceleague.adobe.com/en/docs/commerce-business-intelligence/mbi/start/sign-in)
