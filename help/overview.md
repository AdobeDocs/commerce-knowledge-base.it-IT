...
>[!NOTE]
>
>La guida alla Knowledge Base di supporto di Adobe Commerce è in fase di ristrutturazione e il suo contenuto si sta spostando in altre posizioni all’interno di Adobe Experience League. Utilizza la [pagina di ricerca di Experience League e i filtri](https://experienceleague.adobe.com/en/search#) per trovare i contenuti più recenti relativi alla risoluzione dei problemi e al supporto di Adobe Commerce.
