...
La patch MDVA-35984 risolve il problema quando si creano più spedizioni simultanee per lo stesso prodotto, dando una quantità di prodotto (Qtà) errata. Questa patch è disponibile quando [Strumento Patch di qualità (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.0.21. L&#39;ID della patch è MDVA-35984. Il problema è stato risolto in Adobe Commerce 2.4.3.
...
1. Creare un prodotto semplice con **Qtà** = *100*.
...
Il risultato è prodotto **Qtà** = *98* dopo entrambe le spedizioni.

<u>Risultati effettivi</u>:

Il risultato è prodotto **Qtà** = *99* dopo entrambe le spedizioni.
