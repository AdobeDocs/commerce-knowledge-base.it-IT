...
La patch di MDVA-42855 risolve il problema che impedisce il salvataggio del nuovo indirizzo del cliente nella rubrica durante il pagamento. Questa patch è disponibile quando [Strumento Patch di qualità (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.12. L&#39;ID della patch è MDVA-42855. Il problema è pianificato per essere risolto in Adobe Commerce 2.4.5.
...
1. Alla spedizione, fai clic su **+ Nuovo indirizzo**.
1. Inserisci il nuovo indirizzo e mantieni **Salva nella Rubrica** casella di controllo contrassegnata.
1. Al pagamento, contrassegnare la casella **Il mio indirizzo di fatturazione e spedizione è lo stesso** casella di controllo.
1. Effettua l’ordine.
