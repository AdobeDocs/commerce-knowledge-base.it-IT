...
La patch MDVA-35569 risolve il problema quando FPT (fixed product tax, imposta sul prodotto fissa) non viene visualizzato in GraphQL quando lo stato è specificato nel carrello. Questa patch è disponibile quando è installato [QPT (Quality Patches Tool)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.0.19. L&#39;ID della patch è MDVA-35569. Il problema è stato risolto nella versione 2.4.3 di Adobe Commerce.
...
1. Abilita FPT.
1. Crea un attributo (esempio: *weee\_tax*).
1. Crea un prodotto di prova (esempio: *weetax*) con l&#39;attributo *weee\_tax* aggiunto.
1. Assegna FPT alla California o a un altro stato nell&#39;attributo *weee\_tax*.
1. Creare un cliente in GraphQL.
1. Crea un carrello in GraphQL.
1. Aggiungi il prodotto *weetax* al carrello con GraphQL.
