...
1. Aggiungi intestazione **Valore Bearer autorizzazione del token** ed esegui la seguente query GraphQL:
...
Viene restituito solo &quot;Product 2&quot;, ma il `total_count` mostra due.
